...
def test_open_time():
    ...
    assert open_time(200,200, arrow.get("2023-11-04T12:00:00")) == arrow.get("2023-11-04T05:53:00")
...
def test_close_time():
    ...
    assert close_time(10,200, arrow.get("2023-11-04T00:00:00")) == arrow.get("2023-11-04T01:30:00")
    assert close_time(50,200, arrow.get("2023-11-04T00:00:00")) == arrow.get("2023-11-04T03:30:00")
    ...
    assert open_time(400,400, arrow.get("2023-11-04T12:00:00")) == arrow.get("2023-11-04T03:00:00")
